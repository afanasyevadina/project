...
<form>
	<div class="row">
		...
		<div class="form-group col-sm-6">
			<label class="label-sm">Преподаватель</label>
		...
		<div class="form-group col-sm-4">
			<label class="label-sm">Учебный год</label>
		...
		<div class="form-group col-sm-2">
			...
			<input type="submit" class="btn btn-sm btn-info d-block" value="Показать">
		</div>
	</div>
</form>
@if($teacher)
<div class="text-right mb-2">
	<a href="/load/{{ $teacher->id }}/export/{{ $year }}" class="btn btn-sm btn-outline-success">Экспорт в Excel</a>
</div>
	...
	<table class="table table-sm table-xs table-bordered">
		<thead>
			<tr>
				...
				<th colspan="3" class="text-center">Распределение по семестрам</th>
				<th rowspan="2">К/р</th>
				<th colspan="3" class="text-center">По РУП</th>
				...
				<th colspan="3" class="text-center">1 семестр</th>
				<th colspan="3" class="text-center">2 семестр</th>
